...
import { ARTICLE_ENHANCEMENT_QUERY_KEYS, RSS_QUERY_KEYS, mutationKeys, queryKeys } from "../query-keys";
import type {
    Article,
...
export function createArticleHooks() {
    ...
    function useUpdateArticle(
        ...
        return useMutation({
            ...
            mutationFn: async ({
                ...
                await ApiClient.rss.updateArticle(articleId, updateData);
            },
    ...
    function useInfiniteArticles(
        ...
        return useInfiniteQuery({
            ...
            getNextPageParam: (lastPage: { items: ArticleSummary[]; next_cursor: string | null; has_more: boolean; total_count: number | null }) => lastPage.next_cursor,
    ...
    function useCheckArticleSaved(
        ...
        options?: Omit<
            UseQueryOptions<CheckArticleSavedResponse, Error, CheckArticleSavedResponse, ReturnType<typeof queryKeys.checkArticleSaved>>,
    ...
    function useUnsaveArticle(
        ...
        return useMutation({
            ...
            mutationFn: ({ articleId }: { articleId: string; url: string; }) => {
                return ApiClient.rss.updateArticle(articleId, { is_saved: false }).then(() => undefined);
            },
     ...
     */
    function useExtractFullText(articleId: string, articleUrl?: string) {
        ...
        return useQuery({
            ...
            queryFn: async (): Promise<ExtractFullTextResponse> => {
                ...
                return ApiClient.rss.extractFullText(articleId);
            },
     ...
     */
    function useSummarizeArticle(articleId: string, content?: string) {
        const isValidArticleId =
            articleId && articleId !== "skip" && articleId.length > 0;
        ...
        return useQuery({
            ...
            queryFn: async (): Promise<SummarizeResponse> => {
                ...
                return ApiClient.rss.summarize(articleId, requestBody);
            },
            enabled: false, // Only run when manually triggered
            staleTime: 30 * 60 * 1000, // 30 minutes
            gcTime: 60 * 60 * 1000, // 1 hour
    ...
    async function fetchTranslation(
        ...
        return await queryClient.fetchQuery({
            ...
            queryFn: async (): Promise<TranslateResponse> => {
                ...
                return ApiClient.rss.translate(articleId, requestBody);
            },
