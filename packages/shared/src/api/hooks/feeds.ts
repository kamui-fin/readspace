...
function createFeedHooks(userConfig: FeedHooksConfig = {}) {
    ...
    function useImportTaskStatus(
        ...
        options?: Omit<UseQueryOptions<ImportTaskStatus, Error, ImportTaskStatus, [string, string | null]>, 'queryKey' | 'queryFn'>
    ) {
        return useQuery({
            queryKey: [RSS_QUERY_KEYS.OPML_IMPORT_STATUS, taskId],
            queryFn: () => ApiClient.rss.getImportTaskStatus(taskId!) as Promise<ImportTaskStatus>,
    ...
    // Folder hooks
    function useFolders(
        options?: Omit<UseQueryOptions<Folder[], Error, Folder[], [string]>, 'queryKey' | 'queryFn'>
    ) {
        return useQuery({
    ...
    function useUpdateFolder(
        ...
        return useMutation({
            ...
            onMutate: async ({ folderId, name }) => {
                ...
                queryClient.setQueryData([RSS_QUERY_KEYS.FOLDERS], (old: Folder[] | undefined) => {
                    if (!old) return old
    ...
    function useDeleteFolder(
        ...
        return useMutation({
            mutationFn: async (folderId: string) => {
                ...
                await new Promise((resolve) => setTimeout(resolve, config.deletionDelay))
            ...
            onMutate: async (folderId) => {
                ...
                queryClient.setQueryData(
                    ...
                    (old: SidebarData | undefined) => {
                        ...
                        return {
                            ...
                            feeds: old.feeds
                                ? old.feeds.filter(
                                    (feed: Feed) => feed.folder_id !== folderId
                                )
                                : [],
                        }
                    }
                ...
                queryClient.setQueryData(
                    ...
                    (old: UnreadCounts | undefined) => {
                        ...
                        const newCounts = { ...old }
                        if (newCounts.unread_by_folder && Array.isArray(newCounts.unread_by_folder)) {
                            newCounts.unread_by_folder =
                                newCounts.unread_by_folder.filter(
                                    (item: { folder_id: string; unread_count: number }) => item.folder_id !== folderId
                                )
                        }
                        return newCounts
                    }
    ...
    function useFeeds(
        ...
        options?: Omit<UseQueryOptions<Feed[], Error, Feed[], [string, typeof params]>, 'queryKey' | 'queryFn'>
    ) {
        return useQuery({
    ...
    function useFeed(
        feedId: string,
        options?: Omit<UseQueryOptions<Feed, Error, Feed, [string, string]>, 'queryKey' | 'queryFn'>
    ) {
        return useQuery({
    ...
    function useRefreshFolderFeeds(
        ...
        return useMutation({
            ...
            onSuccess: (data) => {
                config.showSuccess?.("Folder refresh started! Check status for progress.")
                return data
            },
    ...
    function useRefreshStatus(
        taskId: string | null,
        enabled: boolean = true,
        options?: Omit<UseQueryOptions<unknown, Error, unknown, [string, string | null]>, 'queryKey' | 'queryFn'>
    ) {
        return useQuery({
            queryKey: [RSS_QUERY_KEYS.REFRESH_STATUS, taskId],
            queryFn: () => ApiClient.rss.getRefreshStatus(taskId!) as Promise<unknown>,
    ...
    function useArticles(
        ...
        options?: Omit<UseQueryOptions<PaginatedResponse<Article>, Error, PaginatedResponse<Article>, [string, typeof params]>, 'queryKey' | 'queryFn'>
    ) {
        return useQuery({
    ...
    function useRecentlyReadArticles(
        ...
        options?: Omit<UseQueryOptions<PaginatedResponse<Article>, Error, PaginatedResponse<Article>, [string, string, typeof params]>, 'queryKey' | 'queryFn'>
    ) {
        return useQuery({
            queryKey: [RSS_QUERY_KEYS.ARTICLES, "recently_read", params],
            queryFn: () =>
                ApiClient.rss.getRecentlyReadArticles(params.page, params.size) as Promise<PaginatedResponse<Article>>,
            ...options,
        })
    }
    ...
    function useReadLaterArticles(
        ...
        return useQuery({
            ...
            queryFn: () =>
                ApiClient.rss.getReadLaterArticles(params.page, params.size) as Promise<PaginatedResponse<Article>>,
            ...options,
        })
    }
    ...
    function useUnreadCounts(
        folderId?: string,
        options?: Omit<UseQueryOptions<UnreadCounts, Error, UnreadCounts, [string, string | undefined]>, 'queryKey' | 'queryFn'>
    ) {
        return useQuery({
            queryKey: [RSS_QUERY_KEYS.UNREAD_COUNTS, folderId],
            queryFn: () => ApiClient.rss.getUnreadCounts(folderId) as Promise<UnreadCounts>,
            ...options,
        })
    }
    ...
    function useArticle(
        articleId: string,
        options?: Omit<UseQueryOptions<Article, Error, Article, [string, string]>, 'queryKey' | 'queryFn'>
    ) {
        return useQuery({
    ...
    function useSubscribeToFeed(
        ...
        return useMutation({
            ...
            onError: (error: unknown) => {
                ...
                const err = error as { message?: string; detail?: string; response?: { data?: { detail?: string; message?: string } } }
                if (err?.message) {
    ...
    function useInfiniteArticles(
        ...
        options?: UseInfiniteQueryOptions<PaginatedResponse<Article>, Error, PaginatedResponse<Article>, [string, string, typeof params], number>
    ) {
        return useInfiniteQuery({
            queryKey: [RSS_QUERY_KEYS.ARTICLES, "infinite", params],
            queryFn: ({ pageParam }: QueryFunctionContext<[string, string, typeof params], number>) =>
                ApiClient.rss.getArticles({
                    feed_ids: params.feedIds,
                    folder_id: params.folderId,
                    is_read: params.isRead,
    ...
    function useInfiniteRecentlyReadArticles(
        params: { size?: number } = {},
        options?: UseInfiniteQueryOptions<PaginatedResponse<Article>, Error, PaginatedResponse<Article>, [string, string, string, typeof params], number>
    ) {
        return useInfiniteQuery({
            queryKey: [
            ...
            queryFn: ({ pageParam }: QueryFunctionContext<[string, string, string, typeof params], number>) =>
                ApiClient.rss.getRecentlyReadArticles(pageParam, params.size || 25) as Promise<PaginatedResponse<Article>>,
            getNextPageParam: (lastPage: PaginatedResponse<Article>) => {
                const page = lastPage as { page?: number; pages?: number; total_pages?: number }
    ...
    function useInfiniteReadLaterArticles(
        ...
        return useInfiniteQuery({
            ...
            queryFn: ({ pageParam }: QueryFunctionContext<[string, string, string, typeof params], number>) =>
                ApiClient.rss.getReadLaterArticles(pageParam, params.size || 25) as Promise<PaginatedResponse<Article>>,
            getNextPageParam: (lastPage: PaginatedResponse<Article>) => {
                const page = lastPage as { page?: number; pages?: number; total_pages?: number }
                const currentPage = page.page || 1
                const totalPages = page.pages || page.total_pages || 1
