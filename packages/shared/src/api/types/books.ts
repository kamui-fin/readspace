...
export function isEpubProgress(
  progress: unknown
): progress is EpubProgress {
  return (
    progress !== null &&
...
export type UserBookLibraryWithTypedProgress = Omit<UserBookLibrary, 'epub_progress'> & {
...
export function serializeRangeToJson(range: SerializedRange): SerializedRangeJson {
  return {
