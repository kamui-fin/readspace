...
import { Article, ArticleCountsResponse, ArticleSummary, CheckArticleSavedResponse, ExtractFullTextResponse, SaveArticleResponse, SummarizeRequest, SummarizeResponse, TranslateRequest, TranslateResponse } from "../types/articles";
...
export const articles = {
    ...
    updateArticle: (
        ...
        articleType: string = "feed",
    ) => ApiClient.put<void>(`/api/articles/${id}?article_type=${articleType}`, data),
    ...
    extractFullText: (id: string) =>
        ApiClient.post<ExtractFullTextResponse>(`/api/articles/${id}/extract-full-text`),
