...
down_revision: Union[str, None] = '644d0f774254'
...
def upgrade() -> None:
    ...
    op.execute("CREATE INDEX idx_feeds_embedding ON feeds USING ivfflat (embedding vector_cosine_ops) WITH (lists = 100)")
