...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "epub_chapter_char_counts", postgresql.ARRAY(sa.Integer()), nullable=True
        ),
        sa.Column(
            "epub_page_char_counts", postgresql.ARRAY(sa.Integer()), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "last_article_published_at", sa.DateTime(timezone=True), nullable=True
        ),
        sa.Column(
            "created_at",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["content_id"], ["article_contents.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["feed_id"], ["feeds.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "idx_feed_articles_feed_guid", "feed_articles", ["feed_id", "guid"], unique=True
    )
    op.create_table(
        "profiles",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["article_id"], ["feed_articles.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["profiles.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_unique_constraint(
        "uq_user_article_state", "user_article_states", ["user_id", "article_id"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["book_metadata_id"], ["book_metadata.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["user_id"], ["profiles.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["user_book_lib_id"], ["user_book_library.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
...
def downgrade() -> None:
    ...
    op.execute(
        "ALTER TABLE article_contents DROP CONSTRAINT IF EXISTS chk_published_date_bounds"
    )
    ...
    op.execute(
        "ALTER TABLE article_contents DROP CONSTRAINT IF EXISTS chk_read_time_bounds"
    )
    ...
    op.drop_index(
        op.f("ix_clipped_articles_is_read_later"), table_name="clipped_articles"
    )
    op.drop_index(op.f("ix_clipped_articles_is_read"), table_name="clipped_articles")
    op.drop_index(
        op.f("ix_clipped_articles_is_favorite"), table_name="clipped_articles"
    )
    ...
    op.drop_index(
        op.f("ix_article_contents_published_at"), table_name="article_contents"
    )
