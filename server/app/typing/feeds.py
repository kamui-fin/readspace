...
class FeedBase(BaseModel):
    ...
    url: str  # Changed from AnyUrl - validation only on input
...
class AdminFeedUpdate(BaseModel):
    ...
    link: AnyUrl | None = None  # Keep validation on input
    language: str | None = Field(None, max_length=50)
    image_url: str | None = None
    ...
    url: AnyUrl | None = None  # Keep validation on input
