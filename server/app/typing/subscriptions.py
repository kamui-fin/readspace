...
class FeedResponse(BaseModel):
    ...
    id: UUID
    url: str  # Changed from AnyUrl - no validation on output
    title: str | None = None
    description: str | None = None
    link: str | None = None  # Changed from AnyUrl
...
class SubscriptionResponse(BaseModel):
    ...
    - HTTP caching headers (etag, last_modified)

    This reduces response payload by ~3-5KB per subscription.
    """
