...
class TestFeedCreationService:
    ...
    async def test_add_new_feed_success(self):
        ...
        with patch(
            "app.crud.crud_feed.get_feed_by_url",
            new_callable=AsyncMock,
            return_value=None,
        ):
            # Mock folder validation
            with patch(
                "app.crud.crud_folder.get_folder",
                new_callable=AsyncMock,
                return_value=Mock(),
            ):
    ...
    async def test_fetch_and_parse_feed_invalid_status(self):
        ...
        self.service._fetch_feed_content = AsyncMock()
        self.service._fetch_feed_content.return_value = {"status": 404, "content": None}
    ...
    def test_extract_feed_metadata(self):
        ...
        parsed_feed = Mock()
        parsed_feed.get.return_value = {
            "title": "Test",
            "image": {"href": "http://example.com/img.png"},
        }
