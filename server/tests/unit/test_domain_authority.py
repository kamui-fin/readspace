...
def test_get_domain_authority_score_empty_domain():
    ...
    assert get_domain_authority_score("") == 0.0
    assert get_domain_authority_score(None) == 0.0
...
def test_get_domain_authority_score_top_domains():
    ...
    google_score = get_domain_authority_score("google.com")
    assert google_score >= 0.95, f"google.com should score >= 0.95, got {google_score}"

    youtube_score = get_domain_authority_score("youtube.com")
...
def test_get_domain_authority_score_unknown_domain():
    ...
    score = get_domain_authority_score("this-domain-definitely-does-not-exist-12345.com")
    assert score == 0.0