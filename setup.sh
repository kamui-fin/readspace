...
NEXT_PUBLIC_API_BASE_URL=http://0.0.0.0:8008
...
echo "Next steps:"
echo "1. Review the generated .env files to ensure they are correct."
echo "2. You can now start your services (e.g., using docker-compose up)."