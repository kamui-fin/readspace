    ...
    const renderThumb = (value: number) => {
        const thumb = (
            <SliderPrimitive.Thumb
                ...
                className="border-primary bg-background ring-ring/50 block size-4 shrink-0 rounded-full border shadow-xs transition-[color,box-shadow] outline-hidden hover:ring-4 focus-visible:ring-4 disabled:pointer-events-none disabled:opacity-50"
