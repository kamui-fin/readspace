...
export class ApiClient {
    ...
    static rss = {
        ...
        bulkUpdateArticles: (articleIds: string[], action: string) =>
            this.post(`/api/rss/articles/bulk_update`, {
                article_ids: articleIds,
                action,
            }),
        markFeedAsRead: (feedId: string) =>
            this.post<{ affected_articles: number }>(
                `/api/rss/articles/feed/${feedId}/mark-all-as-read`
            ),
        markFolderAsRead: (folderId: string) =>
            this.post<{ affected_articles: number }>(
                `/api/rss/articles/folder/${folderId}/mark-all-as-read`
            ),
    }
}
