...
export const OnboardingFeedItem = ({
    ...
    return (
        <View className="flex-row items-center gap-4 py-3 bg-transparent">
            {/* Icon */}
            <View
            ...
            <View className="flex-1">
                <Text size="base" fontFamily="geist-semibold" className="mb-1 text-black dark:text-white tracking-tight" numberOfLines={1}>
                    {stripHtml(title)}
                </Text>
            ...
            {/* Action Button */}
            <Pressable onPress={handlePress} disabled={isLoading} className="p-2 transition-opacity active:opacity-60">
                {isFollowing ? (
