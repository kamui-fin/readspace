        ...
        return (
            <BottomSheetModal
                ...
                <BottomSheetView className="flex-1 px-6 py-4">
                    ...
                    {/* File Info Card */}
                    <View className="mb-6 rounded-2xl bg-light-grey p-4 dark:bg-light-grey-dark">
                    ...
                    {/* Import Info */}
                    <View className="mb-6 rounded-xl bg-mid-grey p-4 dark:bg-mid-grey-dark">
                    ...
                    <View className="flex-row gap-3">
                        ...
                        <Button
                            ...
                            {isImporting ? (
                                ...
                                <Text
                                    className="font-geist-semibold text-base text-white"
                                    numberOfLines={1}>
