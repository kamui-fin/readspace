...
import { ApiClient, RSS_QUERY_KEYS, useActiveImportTask, useImportTaskStatus } from '@readspace/shared';
...
export default function ImportOPMLScreen() {
    ...
    const { data: taskStatus } = useImportTaskStatus(
        currentTaskId,
        !!currentTaskId && shouldPoll
    );
            ...
            <ScrollView className="flex-1">
                {isCheckingTask ? (
                    ...
                    <View className="px-6">
                        ...
                        <Text className="px-2 font-geist-medium text-sm text-grey dark:text-grey">
                            Select a .opml or .xml file containing your exported subscriptions from another RSS reader to import them directly into your account.
                        </Text>
                    </View>
                )}
            </ScrollView>
